...
mod glow_integration {
    ...
    impl GlutinWindowContext {
        ...
        fn try_window(&self) -> Option<&winit::window::Window> {
            self.window.as_ref()
        }
    ...
    impl GlowWinitApp {
        ...
        fn init_run_state(&mut self, event_loop: &EventLoopWindowTarget<UserEvent>) -> Result<()> {
            ...
            let window = gl_window.try_window().expect("A valid window");
    ...
    impl WinitApp for GlowWinitApp {
        ...
        fn window(&self) -> Option<&winit::window::Window> {
            self.running.as_ref().and_then(|r| r.gl_window.try_window())
        }
        ...
        fn run_ui_and_paint(&mut self) -> EventResult {
            ...
            let Some(window) = gl_window.try_window() else {
                log::error!("run_ui_and_paint(): window missing");
                return EventResult::Wait;
            };
